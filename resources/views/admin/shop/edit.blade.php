...
<body>
  <div class="container pt-5">
    <div class="row pt-5">
      ...
      <form class="login-form" method="POST" action="{{ route('admin.product.update', ['product' => $product]) }}"
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            ...
            <textarea name="shortInfo">{{ $product->shortInfo }}</textarea><br>

            <label for="deltailInfo">Mô tả chi tiết:</label><br>
            <textarea name="deltailInfo">{{ $product->deltailInfo }}</textarea><br>
